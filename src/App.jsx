      ...
      <section className="features" id="features">
        ...
        <div className="features-grid">
          {[
            ...
            {bg:'#f0fdfa',c:'#0f766e',icon:'ti-scale',title:'Sold by Weight Pricing',desc:'Selling meat, fish, rice, or anything priced per kilo? Set a price per unit, and the cashier just types the weight — the price calculates instantly, no calculator needed. Perfect for wet markets, groceries, and food stalls.',tags:['Price per kilo','Type weight, done','Stock tracked by weight','Accurate receipts']},
