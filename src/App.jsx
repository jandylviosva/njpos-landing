      ...
      <section className="features" id="features">
        ...
        <div className="features-grid">
          {[
            ...
            {bg:'#dcfce7',c:'#16a34a',icon:'ti-box',title:'Real-time Inventory',desc:'Stock updates automatically on every sale. Add products with photos — upload or snap a picture right from your camera — set up size, color, or flavor variants with their own pricing and stock, import via CSV, and track every adjustment in a full audit log.',tags:['Auto deductions','Product variants','Camera or upload photos','CSV import/export']},
            {bg:'#f0fdfa',c:'#0f766e',icon:'ti-scale',title:'Sold by Weight Pricing',desc:'Selling meat, fish, rice, or anything priced by weight or volume? Set a price per unit — kilo, gram, liter, whatever fits your product — and the cashier just types the amount. The price calculates instantly, no calculator needed. Perfect for wet markets, groceries, and food stalls.',tags:['Any unit: kg, g, L…','Type amount, done','Stock tracked by unit','Accurate receipts']},
            ...
            {bg:'#fef3c7',c:'#b45309',icon:'ti-clock',title:'Shift Management',desc:'Staff open and close shifts with cash counts. Track sales, expenses, and over/short per shift. A shift survives an app crash or accidental refresh, and a second staff member can safely take over mid-shift without losing a thing.',tags:['Opening cash','Per-shift reports','Staff handoff','Over/short']},
            ...
            {bg:'#fce7f3',c:'#be185d',icon:'ti-cloud-upload',title:'Cloud Sync & Owner Portal',desc:'Data syncs in real time. Check today\'s sales, manage products, and add staff from any device via the Owner Portal. The app keeps itself up to date automatically, so you\'re always on the latest version.',tags:['Works offline','Auto sync','Auto-updates','Multi-device']},
